...
-- state_out[1]	=>  Location: PIN_12,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- state_out[4]	=>  Location: PIN_11,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
PORT MAP (
	...
	datab => \io~q\,
	datac => \u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_cdr~0_combout\,
...
-- Equation(s):
-- \datau[0]~1_combout\ = (\datau[0]~0_combout\ & (!\dut_instance|add_instance|ff3|Q~q\ & ((!\u0|virtual_jtag_0|sld_virtual_jtag_basic_inst|virtual_state_sdr~0_combout\)))) # (!\datau[0]~0_combout\ & (((datau(0)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|ff3|Q~q\,
...
-- Equation(s):
-- \data[1]~feeder_combout\ = \altera_internal_jtag~TDIUTAP\
...
\dut_input[0]~feeder\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_input[0]~feeder_combout\ = data(0)
...
PORT MAP (
	datad => data(0),
	combout => \dut_input[0]~feeder_combout\);
...
\dut_instance|add_instance|ff2|Q~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|ff2|Q~0_combout\ = !\dut_instance|add_instance|ff2|Q~q\
...
PORT MAP (
	...
	combout => \dut_instance|add_instance|ff2|Q~0_combout\);
...
PORT MAP (
	...
	d => \dut_instance|add_instance|ff2|Q~0_combout\,
...
\dut_instance|add_instance|ff1|Q~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \dut_instance|add_instance|ff1|Q~0_combout\ = (\dut_instance|add_instance|ff2|Q~q\ & (\dut_instance|add_instance|ff3|Q~q\)) # (!\dut_instance|add_instance|ff2|Q~q\ & ((\dut_instance|add_instance|ff1|Q~q\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \dut_instance|add_instance|ff2|Q~q\,
	datab => \dut_instance|add_instance|ff3|Q~q\,
	datac => \dut_instance|add_instance|ff1|Q~q\,
	combout => \dut_instance|add_instance|ff1|Q~0_combout\);
...
PORT MAP (
	clk => \dut_input[0]~clkctrl_outclk\,
	d => \dut_instance|add_instance|ff1|Q~0_combout\,
	clrn => \ALT_INV_dut_input[1]~clkctrl_outclk\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \dut_instance|add_instance|D\(0) = (!\dut_instance|add_instance|ff1|Q~q\ & (\dut_instance|add_instance|ff2|Q~q\ $ (\dut_instance|add_instance|ff3|Q~q\)))
...
PORT MAP (
	...
	datad => \dut_instance|add_instance|ff1|Q~q\,
