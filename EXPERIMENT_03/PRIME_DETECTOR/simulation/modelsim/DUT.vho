...
SIGNAL \add_instance|OR1|Y~0_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|OR1|Y~0_combout\,
	devoe => ww_devoe,
...
\add_instance|OR1|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|OR1|Y~0_combout\ = (\input_vector[2]~input_o\ & (\input_vector[0]~input_o\ & ((!\input_vector[1]~input_o\) # (!\input_vector[3]~input_o\)))) # (!\input_vector[2]~input_o\ & (\input_vector[1]~input_o\ & ((\input_vector[0]~input_o\) # 
-- (!\input_vector[3]~input_o\))))
...
PORT MAP (
	...
	combout => \add_instance|OR1|Y~0_combout\);
