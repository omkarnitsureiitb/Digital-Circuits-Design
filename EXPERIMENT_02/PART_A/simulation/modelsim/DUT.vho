...
-- Design Ports Information
-- input_vector[1]	=>  Location: PIN_106,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- input_vector[0]	=>  Location: PIN_26,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[2]	=>  Location: PIN_23,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- input_vector[4]	=>  Location: PIN_25,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \add_instance|AND1|Y~0_combout\ : std_logic;
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|AND1|Y~0_combout\,
	devoe => ww_devoe,
...
-- pragma translate_on
PORT MAP (
	i => \add_instance|AND2|Y~0_combout\,
	devoe => ww_devoe,
...
\add_instance|AND1|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|AND1|Y~0_combout\ = (\input_vector[0]~input_o\ & ((\input_vector[4]~input_o\) # (\input_vector[2]~input_o\)))
...
PORT MAP (
	...
	combout => \add_instance|AND1|Y~0_combout\);
...
\add_instance|AND2|Y~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \add_instance|AND2|Y~0_combout\ = (\input_vector[0]~input_o\ & ((\input_vector[4]~input_o\) # (\input_vector[3]~input_o\)))
